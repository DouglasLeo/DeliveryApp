...
public record UpdateOrderCommand(Guid Id, Guid UserId, EOrderStatus OrderStatus) : IRequest;

public class UpdateOrderHandler(
    IOrderRepository orderRepository,
    IUserRepository userRepository) : IRequestHandler<UpdateOrderCommand>
{
