...
public class GetAllFoodsWithInactivesQueryHandler(IFoodRepository foodRepository)
    : IRequestHandler<GetAllFoodsWithInactivesQuery, IEnumerable<FoodDto>>
{
    public async Task<IEnumerable<FoodDto>> Handle(GetAllFoodsWithInactivesQuery request, CancellationToken cancellationToken)
