...
namespace DeliveryApp.Infrastructure.Persistence.Postgres.Shared.Repositories;
...
public class Repository<T> : IRepository<T> where T : Entity
{
    ...
    public async Task<IEnumerable<T>>
        Search(Expression<Func<T, bool>> predicate, CancellationToken cancellationToken) =>
